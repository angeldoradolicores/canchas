          ...
          return (
            <div className="order-1 md:order-3 relative mb-8 sm:mb-10 rounded-3xl sm:rounded-2xl overflow-hidden group border border-border shadow-lg shadow-black/5 sm:shadow-none">
              ...
              <button
                ...
                onClick={toggleFavorite}
                disabled={loadingFavorite}
                className={`absolute top-3 left-3 z-30 p-2.5 rounded-full border shadow-lg backdrop-blur-md transition-all duration-300 hover:scale-110 active:scale-90 disabled:opacity-50 ${isFavorite
          ...
          <div className="bg-card px-4 py-5 sm:p-6 md:p-8 rounded-[28px] md:rounded-2xl border border-border shadow-sm shadow-black/[0.03] md:shadow-sm">
            ...
            {(igUrl || ttUrl || fbUrl) && (
              <div className="mt-3 sm:mt-4 p-4 bg-emerald-500/5 dark:bg-emerald-500/10 border border-emerald-500/15 dark:border-emerald-500/20 rounded-3xl sm:rounded-2xl">
                ...
                {/* Contenedor horizontal en móvil y PC con flex y centrado perfecto */}
                <div className="flex items-center justify-center sm:justify-start gap-3">
                  ...
                  {igUrl && (
                    <a
                      ...
                      title="Instagram"
                      className="w-11 h-11 rounded-2xl border border-pink-500/20 bg-gradient-to-r from-pink-500/10 via-rose-500/5 to-amber-500/10 hover:border-pink-500/40 hover:shadow-md transition-all active:scale-95 cursor-pointer flex items-center justify-center group"
                    >
                  ...
                  {ttUrl && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      title="TikTok"
                      className="w-11 h-11 rounded-2xl border border-neutral-300 dark:border-neutral-700 bg-neutral-100/90 dark:bg-neutral-900/90 hover:border-black dark:hover:border-white hover:shadow-md transition-all active:scale-95 cursor-pointer flex items-center justify-center group"
                    >
                  ...
                  {fbUrl && (
                    <a
                      ...
                      rel="noopener noreferrer"
                      title="Facebook"
                      className="w-11 h-11 rounded-2xl border border-blue-500/20 bg-blue-500/10 hover:border-[#1877F2]/50 hover:shadow-md transition-all active:scale-95 cursor-pointer flex items-center justify-center group"
                    >
